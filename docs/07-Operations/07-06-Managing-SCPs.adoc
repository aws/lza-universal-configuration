...
LZA defines SCPs in separate JSON files that you reference in the `policySets` section of the `organization-config.yaml` file. This modular approach provides several advantages:
