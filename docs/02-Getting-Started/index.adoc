...
Optionally, you can use https://docs.aws.amazon.com/transform/latest/userguide/transform-vmware-migrate-network.html[AWS Transform] to make configuration files.  AWS Transform migrates VMware networks to AWS by translating your source environment configuration into AWS-equivalent network resources. 