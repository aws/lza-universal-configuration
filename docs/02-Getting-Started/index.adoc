...
Optionally, you can use https://docs.aws.amazon.com/transform/latest/userguide/transform-vmware-migrate-network.html[AWS Transform] to automate transformation of VMware network environments into LZA-compatable network configuration YAML files.  
